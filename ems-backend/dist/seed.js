    ...
    const tasks = await models_1.Task.insertMany([
        {
            ...
            status: interfaces_1.TaskStatus.CurrentlyWorking,
        ...
        },
        {
            ...
            status: interfaces_1.TaskStatus.TestingVerified,
        ...
        },
        {
            ...
            status: interfaces_1.TaskStatus.MockupWorking,
        ...
        },
        {
            ...
            status: interfaces_1.TaskStatus.TestingStarted,
